...
O projeto contém dois repositórios principais (git submodules/forks):
...
### 2. **Truth Discovery Comparative Analysis**
...
# Ou executar o experimento para o dataset Movies
./run_movies_all.sh
```
...
- Múltiplas fontes (OMDB + Wikidata + TMDB + CINEMETA + LETTERBOX)
- Dados conflitantes e incompletos
- Múltiplas verdades possíveis

### Características
- **1500 - 6000 filmes** com metadados
